...
class _HomeViewState extends State<HomeView> {
  ...
  final List<Category> CrossFit = [
    Category(
      imageUrl: "assets/images/ropeClaim.png",
      name: "rope claim",
    ),
    Category(
      imageUrl: "assets/images/terkishGetUp.png",
      name: "terkish get up",
    ),
    Category(
      imageUrl: "assets/images/snatch.png",
      name: "snatch",
    ),
  ];
  final List<Category> FullBody = [
    ...
    Category(
      imageUrl: "assets/images/triceps.png",
      name: "triceps",
    ),
    Category(
  ...
  final List<Category> hardWork = [
    Category(
      imageUrl: "assets/images/battleRope.png",
      name: "battleRope",
    ),
    Category(
    ...
    Category(
      imageUrl: "assets/images/machinePush.png",
      name: "machinePush",
    ),
  ];
  @override
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                              image: AssetImage("assets/images/emely.png"),
                              fit: BoxFit.cover),
                        ),
                      )
                    ],
