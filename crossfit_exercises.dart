...
class Crossfit_exercises extends StatefulWidget {
  const Crossfit_exercises({Key? key}) : super(key: key);

  @override
  State<Crossfit_exercises> createState() => _CrossfitExerciseState();
}

class _CrossfitExerciseState extends State<Crossfit_exercises> {
